...
function chatGenerator(index) {
    const names = ["Ali", "Ahmed", "Usman", "Nadeem", "jamil", "farooq", "Ahsan", "Muhammad", "Usman", "Jamal", "Haider", "Haroon", "Latif", "Mehmood", "Hassan", "Hussnain", "Imran", "Babar", "Rizwan", "Waseem", "Ehmad", "Zubair", "Fazian", "Sufiyan", "Noman", "Rahseed", "Raheel", "Raiz", "Jutt", "Elyana", "Salyha", "Abdullah", "Master", "Saleem", "Gujjar", "Sikandar", "Sarmad", "Zain", "Musraaf", "Saffi", "Awais", "Gondal", "Warriach", "Tarar", "Holly Graham", "Farooq", "Ahsan", "Azam", "Nazar", "Liaqat"]
